...
| [@powerycy](https://github.com/powerycy) 跑跑蹦蹦跳跳 | 项目负责人（Admin） | 不参评 | 两类贡献文档与维护贡献评分 | 项目发起至今 |
...
技术 PR 的审核、测试验证与合并全部由正式维护者完成，项目负责人不参与技术审核或兜底。项目负责人负责 PR 项目贡献和维护贡献两类文档，并单方面决定维护贡献评分；本页摘要由维护者按贡献文档同步。
