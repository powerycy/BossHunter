...
import { BriefcaseBusiness, Bot, Github, LayoutDashboard, Radar, Settings } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/ai-settings', icon: Bot, label: 'AI 设置' },
]
      ...
      <div className="h-16 flex items-center px-5 border-b border-card-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-muted">v2.2 · 本地控制台</div>
          </div>
        </div>
      </div>
