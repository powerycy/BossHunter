...
| 字段 | 已核事实 |
|---|---|
| 标题 | 开源求职agent，当福利发出来吧～ |
| 原始公开链接 | <https://www.xiaohongshu.com/discovery/item/6a6742800000000006013a4f?source=webshare&xhsshare=pc_web&xsec_token=ABSiguDxEjbjxxeOOS4WZewoc_lcfHGu1M6u-fHeiqi-A=&xsec_source=pc_share> |
| Item ID | `6a6742800000000006013a4f` |
| 链接核验 | 2026-08-06 返回 HTTP 200，页面标题与用户提供标题一致 |
| 官方表单处理 | 已提交作品的实际字段中没有小红书链接项，因此未写入其他字段 |
