...
from bosshunter.ai.scorer import _build_scoring_prompt
from bosshunter.collection.models import JobCandidate, classify_recruitment_type
from bosshunter.db import get_db, insert_job_if_new
